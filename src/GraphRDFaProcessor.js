...
const RDFaProcessor = require('./RDFaProcessor.js');
class GraphRDFaProcessor extends RDFaProcessor{
  constructor (target) {
    super (target);
    this.rdfaCopyPredicate = "http://www.w3.org/ns/rdfa#copy";
    this.rdfaPatternType = "http://www.w3.org/ns/rdfa#Pattern";
  }
